...
const QRIdentity: React.FC = () => {
    ...
    return (
        <div className="min-h-full flex flex-col items-center justify-center p-4 md:p-8 fade-in">
            <div className={`w-full max-w-lg bg-surface dark:bg-institutional-950 rounded-[3rem] shadow-strong border border-institutional-200 dark:border-institutional-800 overflow-hidden relative transition-all duration-500`}>
                ...
                <div className="p-10 md:p-14 flex flex-col items-center text-center">
                        ...
                        <h2 className="text-3xl font-black tracking-tight text-institutional-900 dark:text-institutional-50 mb-2 uppercase">
                            {user?.name}
                        </h2>
                    ...
                    <div className="relative group mb-12">
                        ...
                        <div className="mt-8 flex items-center justify-center gap-3 opacity-40 group-hover:opacity-80 transition-opacity">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-institutional-900 dark:text-institutional-50">{t('dashboard.scanPresence')}</span>
                        </div>
                    </div>
