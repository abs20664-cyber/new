...
import { ShieldCheck, Mail, Lock, Loader2, AlertCircle, ChevronDown, GraduationCap, Globe, LogIn } from 'lucide-react';
...
const Login: React.FC = () => {
    ...
    const fillCredentials = (u: User) => {
        ...
        } else if (u.email === 'economic@gmail.com') {
            setPassword('economic');
        } else if (u.email === 'teacher@gmail.com') {
            setPassword('Fatima Zohra');
        } else if (u.password) {
