                ...
                <div className="academic-card p-6 text-start space-y-4 shadow-soft">
                    ...
                    <div className="bg-institutional-50 dark:bg-institutional-900/50 border border-institutional-200 dark:border-institutional-800 p-4 rounded-xl">
                        ...
                        <div className="flex gap-2">
                            <button onClick={() => handleUpdateTeacherPayment(t_user.id, 'Paid')} className={`flex-1 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${pay?.status === 'Paid' ? 'bg-emerald-500 text-institutional-50' : 'bg-institutional-100 dark:bg-institutional-800 text-institutional-400'}`}>Paid</button>
                            ...
                            <button onClick={() => handleUpdateTeacherPayment(t_user.id, 'Unpaid')} className={`flex-1 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${pay?.status === 'Unpaid' ? 'bg-rose-500 text-institutional-50' : 'bg-institutional-100 dark:bg-institutional-800 text-institutional-400'}`}>Unpaid</button>
                        </div>
                    </div>
            ...
            <td className="px-8 py-6 text-end">
                <div className="flex justify-end gap-3">
                    <button 
                        ...
                        className={`p-3 rounded-xl transition-all ${pay?.status === 'Paid' ? 'bg-emerald-500 text-institutional-50' : 'bg-institutional-50 dark:bg-institutional-800 text-institutional-400 hover:bg-emerald-500/10 hover:text-emerald-500'}`}>
                        <CheckCircle size={20} />
                    </button>
                    <button 
                        onClick={() => handleUpdateTeacherPayment(t_user.id, 'Unpaid')}
                        className={`p-3 rounded-xl transition-all ${pay?.status === 'Unpaid' ? 'bg-rose-500 text-institutional-50' : 'bg-institutional-50 dark:bg-institutional-800 text-institutional-400 hover:bg-rose-500/10 hover:text-rose-500'}`}>
                        <XCircle size={20} />
                    </button>
                    <button 
                        onClick={() => handleUpdateTeacherPayment(t_user.id, 'Pending')}
                        className={`p-3 rounded-xl transition-all ${pay?.status === 'Pending' || !pay?.status ? 'bg-primary text-institutional-50' : 'bg-institutional-50 dark:bg-institutional-800 text-institutional-400 hover:bg-primary/10 hover:text-primary'}`}>
                        <Clock size={20} />
                    </button>
                </div>
            </td>
